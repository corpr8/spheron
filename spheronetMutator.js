...
SpheronetMutator.prototype.mutateTimeout = function(){
	...
	//this is the expected number of system ticks from the input stimuli to measuring the result at the output
	//this is because we are an event orientated thing
...
SpheronetMutator.prototype.insertConnection = function(){
	...
	var thisSpheronNewPortId = generateUUID()
	var thisOtherSpheron = this._getRandomSpheron()
	var thisOtherSpheronNewPortId = generateUUID()
...
SpheronetMutator.prototype.insertSpheron = function(){
	...
	var newSpheronInputPortId = generateUUID()
	var newSpheronOutputPortId = generateUUID()
